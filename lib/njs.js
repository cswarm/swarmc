...
const sys_d = require('debug')('swarmc:syscall');
const njs_d = require('debug')('swarmc:njs');
...
module.exports = class Njs {
  ...
  host_emu_version() {
    ...
    try {
      ...
      return require('../package.json').version+'-'+fs.readFileSync('.git/refs/heads/master', 'utf8').substr(0, 7);
    }
